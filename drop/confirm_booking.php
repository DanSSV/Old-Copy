...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO booking (pickuppoint, dropoffpoint, toda, status, fare, convenienceFee, passengerCount, driverETA, distance, commuterid, bookingdate, ETA) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW(), ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("sssssssssss", $pickuppoint, $dropoffpoint, $dropoffTodaName, $status, $fare, $convenienceFee, $passengerCount, $driverETA, $distanceKilometers, $commuterid, $ETA);
